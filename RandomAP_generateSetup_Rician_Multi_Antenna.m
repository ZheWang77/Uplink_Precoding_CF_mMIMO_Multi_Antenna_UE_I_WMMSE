function [channelGain] = RandomAP_generateSetup_Rician_Multi_Antenna(M,K,nbrOfSetups,correlatedShadowing)
%%=============================================================
%The file is used to generate realizations of the simulation setup with 
%correlated Rayleigh fading and multi-antenna APs and UEs of the paper:
%
...
%Go through all UEs
 for k = 1:K
     ...
     [distances_Hori] = min(abs(APpositionsWrapped - repmat(UEpositions(k),size(APpositionsWrapped))),[],2);
